...
const Home = () => {
  ...
  const slides = [
    {
      id: 1,
      image: process.env.PUBLIC_URL + '/sliders/slider1.jpg',
    ...
    {
      id: 2,
      image: process.env.PUBLIC_URL + '/sliders/slider2.jpg',
    ...
    {
      id: 3,
      image: process.env.PUBLIC_URL + '/sliders/slider3.jpg',
    ...
    {
      id: 4,
      image: process.env.PUBLIC_URL + '/sliders/slider4.jpg',
    ...
    {
      id: 5,
      image: process.env.PUBLIC_URL + '/sliders/slider5.jpg',
    ...
    {
      id: 6,
      image: process.env.PUBLIC_URL + '/sliders/slider6.jpg',
    ...
    {
      id: 7,
      image: process.env.PUBLIC_URL + '/sliders/slider7.jpg',
  ...
  const partnershipSlides = [
    ...
    },
    {
      ...
      image: process.env.PUBLIC_URL + "/partnership-agreement.jpg" // Your agreement image
    }
  ];
              ...
              {index === currentSlide && (
                <div className="slide-content" key={currentSlide}>
                  <div className="slide-logo">
                    <img src={process.env.PUBLIC_URL + "/logo/logo.png"} alt="PMI IT Logo" className="pmi-logo" />
                  </div>
      ...
      <div className="container" style={{ marginTop: '40px', marginBottom: '10px' }}>
        <div className="about-logos-section">
          <div className="about-logo about-logo-left">
            <img src={process.env.PUBLIC_URL + "/logo/logo.png"} alt="PMI IT Logo" className="about-logo-img" />
          </div>
          ...
          <div className="about-logo about-logo-right">
            <img src={process.env.PUBLIC_URL + "/logo/futurecities-logo.png"} alt="FutureCitiesCouncil Logo" className="about-logo-img" />
          </div>
        </div>
      </div>

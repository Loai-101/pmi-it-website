...
import {
  FaBuilding, FaShip, FaHospital, FaIndustry, FaShoppingCart, FaRoad,
  FaIndustry as FaIndustry2, FaCar, FaCogs, FaDatabase, FaUsers, FaChartLine,
} from 'react-icons/fa';
...
export const projects = [
  {
    ...
    countries: ['tn', 'us'],
    description:
      'A comprehensive national platform designed to streamline social aid distribution and beneficiary management across Tunisia, ensuring compliance with international standards and efficient service delivery.',
  },
  {
    id: 2,
    ...
    countries: ['tn', 'fr'],
    description:
      'Advanced administrative platform for managing public-private partnerships with integrated electronic document management and workflow automation.',
  },
  {
    id: 3,
    ...
    countries: ['tn', 'fr', 'de'],
    description:
      'Comprehensive platform for managing and tracking national development initiatives with multi-stakeholder collaboration and real-time monitoring capabilities.',
  },
  {
    id: 4,
    ...
    countries: ['tn'],
    description:
      "Complete maritime logistics solution covering shipping operations, customs management, and marine services for one of Tunisia's leading shipping companies.",
  },
  {
    id: 5,
    ...
    scope:
      'Development of a centralized platform for healthcare data analysis and business intelligence. The system integrates data from various sources to provide real-time dashboards, performance indicators, and decision-support tools for healthcare administrators and policymakers.',
  ...
  },
  {
    ...
    countries: ['tn'],
    description:
      'Specialized ERP system for the food and agriculture industry with HACCP compliance, ensuring food safety and quality management throughout the production chain.',
  },
  {
    id: 7,
    ...
    countries: ['tn', 'fr'],
    description:
      'Integrated e-commerce and delivery management platform providing seamless online shopping experience with efficient delivery tracking and management.',
  },
  {
    id: 8,
    ...
    countries: ['ga'],
    description:
      'Comprehensive ERP solution for construction and infrastructure projects with ISO compliance and project management capabilities.',
  },
  {
    id: 9,
    ...
    countries: ['ly'],
    description:
      'Advanced clinic management system with WHO and ICD11 compliance, designed for private healthcare facilities with comprehensive patient and medical record management.',
  },
  {
    id: 10,
    ...
    countries: ['fr'],
    description:
      'Specialized ERP system for electronics manufacturing with production planning, quality control, and supply chain management capabilities.',
  },
  {
    id: 11,
    ...
    countries: ['tn', 'de'],
    description:
      'Custom-built ERP system for chemical manufacturing with ISCC compliance, featuring advanced production planning and safety management.',
  },
  {
    id: 12,
    ...
    countries: ['tn', 'fr'],
    description:
      'Modern retail platform with integrated POS systems and microservices architecture for scalable and efficient retail operations.',
  },
  {
    id: 13,
    ...
    countries: ['fr'],
    description:
      'Comprehensive SaaS platform for car rental services with mobile app integration, fleet management, and customer booking systems.',
  },
];
